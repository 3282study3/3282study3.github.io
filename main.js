...
$(function() {
  ...
  function set_settings() {
    ...
    settings.defaultredirect = 'http://nusbschool.az1.qualtrics.com/SE/?SID=SV_bg9Fu9eczADFpvn';
    ...
    // In condition 1, the participant will receive 6 likes at the following timepoint (in ms). Default: [12000, 9999999]
    settings.condition_1_likes = [10000, 15000,35000,80000,93000,110000]; 
